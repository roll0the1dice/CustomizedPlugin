...
public class SnowflakeIdGeneratorPlugin extends PluginAdapter {

  private String targetPackage;

  private Properties properties;

  public SnowflakeIdGeneratorPlugin(Properties properties) {
    super();
    this.properties = properties;
  }

  public SnowflakeIdGeneratorPlugin() {
    super();
  }
  ...
  public List<GeneratedJavaFile> contextGenerateAdditionalJavaFiles(IntrospectedTable introspectedTable) {
    ...
    // modelClassName;
    Interface annotation = new Interface(packageName + "." + "SnowflakeIdGenerator");
    ...
    annotation.addImportedType(new FullyQualifiedJavaType(packageName + "." + "SnowflakeIdGeneratorImpl"));
    annotation.addImportedType(new FullyQualifiedJavaType("org.hibernate.annotations.IdGeneratorType"));
    annotation.addImportedType(new FullyQualifiedJavaType("java.lang.Long"));

    annotation.addAnnotation("@IdGeneratorType(SnowflakeIdGeneratorImpl.class)");
    annotation.addAnnotation("@Target(ElementType.FIELD)");
    annotation.addAnnotation("@Retention(RetentionPolicy.RUNTIME)");

    Field workerId = new Field ("workerId() default 1L", new FullyQualifiedJavaType("long"));
    annotation.addField(workerId);

    Field datacenterId = new Field ("datacenterId() default 1L", new FullyQualifiedJavaType("long"));
    annotation.addField(datacenterId);
