...
public class GlobalExceptionAdvice {
    @ExceptionHandler(com.example.custom_plugin.service.InternalServerException.class)
    @ResponseStatus(HttpStatus.INTERNAL_SERVER_ERROR)
    public ResponseEntity<?> GlobalExceptionAdvice(InternalServerException ex) {
